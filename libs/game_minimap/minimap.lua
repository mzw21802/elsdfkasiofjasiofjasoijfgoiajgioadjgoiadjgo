...
function toggle()
  if minimapWindow:isVisible() then
     if not modules.game_playerbars.minimapButton:isChecked() then
        minimapWindow:close()
     end
  else
     if modules.game_playerbars.minimapButton:isChecked() then
        minimapWindow:open()
     end
  end
end
...
function bindedToggle()
  if minimapWindow:isVisible() then
     if modules.game_playerbars.minimapButton:isChecked() then
        modules.game_playerbars.minimapButton:setChecked(false)
        minimapWindow:close()
     end
  else
     if not modules.game_playerbars.minimapButton:isChecked() then
        modules.game_playerbars.minimapButton:setChecked(1)
        minimapWindow:open()
     end
  end
end
