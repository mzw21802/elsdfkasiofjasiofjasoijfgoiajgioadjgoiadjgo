...
function processMouseAction(menuPosition, mouseButton, autoWalkPos, lookThing, useThing, creatureThing, attackCreature)
  ...
  local player = g_game.getLocalPlayer()
    if useThing and keyboardModifiers == KeyboardNoModifier and mouseButton == MouseRightButton and not g_mouse.isPressed(MouseLeftButton) then
      local player = g_game.getLocalPlayer()
      if useThing and useThing:getId() == 1948 or useThing:getId() == 1639 or useThing:getId() == 1386 or useThing:getId() == 1633 or useThing:getId() == 1630 or useThing:getId() == 1641 or useThing:getId() == 435 then
         g_game.use(useThing)
         return true
...
function updateFps(fps)
  modules.game_interface.fpsLabel:setText('FPS: ' .. fps)
  modules.game_interface.fpsLabel:setColor('white')
end
