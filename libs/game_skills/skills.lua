...
function init()
  ...
  g_keyboard.bindKeyDown('Ctrl+S', bindedToggle)
...
function refresh()
  ...
  skillsWindow:setContentMaximumHeight(360)

  if skillsWindow:isVisible() then
     if not modules.game_playerbars.skillsButton:isChecked() then
...
function toggle()
  if skillsWindow:isVisible() then
     ...
     if modules.game_playerbars.skillsButton:isChecked() then
        skillsWindow:open()
     end
  end
end
